...
| --- | --- | --- | --- |
| POST | `/v1/dispute` | `write:disputes` | Open a dispute with parties, evidence CID, optional scope CID, and stake. |
...
| POST | `/v1/appeal` | `write:disputes` | Submit stake-backed appeal evidence. |
